...
<body>
	...
	<!-- 파라미터의 text 인코딩을 UTF-8 로 선언하여 한글꺠짐을 방지  -->
	...
	<!--
      ...
      객체의 setter 를 이용한 방법 
      만약 parameter 를 받을 떄 파라메터의 key 값과
      setter(또는 변수이름) 이 다를 경우에는
      param 이라는 속성에 대입할 데이터의 key 이름을 써주면 된다.
    -->
	<jsp:setProperty property="userId" name="loginInfo" param="id"/>
...
<%	
		...
		*/
		...
		try{
			...
			pstmt.setString(1,loginInfo.getUserId());	//첫번째 파라미터
			pstmt.setString(2,loginInfo.getUserPw());	//두번째 파라미터
