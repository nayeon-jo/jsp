...
public class DBCPInit extends HttpServlet{
	private static final long serialVersionUID = 1L;	//데이터 직렬화 시 같은 데이터를 검증하기위한 ID 값. 나중에 내부에서 재생성되기떄문에 default 값만 부여하면됨
	...
	private void initDBConnection() {
		try {
			...
			ConnectionFactory connFactory=new DriverManagerConnectionFactory(url,id,passwd);	//DB 커넥션을 생성할 공장 만들기
